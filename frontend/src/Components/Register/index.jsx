            ...
            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
              <div className="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  id="FirstName"
                  name="first_name"
                  className="mt-1 p-2 w-full rounded-md focus:border-gray-200 bg-white text-sm focus:text-gray-700 shadow-sm border-blue-500 ring-2 ring-blue-200"
